...
it('enseña a cada rol solo lo que su Policy le permite', function (Rol $rol, array $esperadas): void {
    ...
    'admin' => [Rol::Admin, ['inicio', 'calendario', 'solicitudes', 'evaluaciones', 'inventario', 'reposicion', 'formatos-confidencialidad', 'plantillas-confidencialidad', 'casos-clinicos', 'usuarios', 'reportes']],
]);
